...
function File() {
  ...
  return (
    <div className='w-screen h-screen flex flex-col items-center text-[#d0ed57]'>
      ...
      <div>
          <a href='/manual'><button className="fixed top-10 right-10 border-2 border-[#d0ed57] border-solid p-2 text-l font-sans font-semibold shadow-[5px_5px_0_0_rgba(208,237,87,1)] hover:bg-[#d0ed57] hover:bg-opacity-10 active:scale-95 transition duration-150 ease-in-out">Input From File</button></a>
      </div>
      <div>
